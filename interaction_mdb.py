...
from mdb_command import MDB_upload, generate_random_query
from mdb_command import MDB_connect
...
while True:
    ...
    if x == 'NoSQL':
        print("\nHere are some possible NoSQL queries to fit your request.\n")
        generate_random_query(df)
